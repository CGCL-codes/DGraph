...
## Support or Contact
DGraph is developed in the [HUST SCTS&CGCL Lab]!(http://grid.hust.edu.cn/). If you are interested in trying out DGraph in your machine, please contact Yu Zhang(zhyu@hust.edu.cn). You are also welcomed to commit or fork your modification for support in the project's page in github.
